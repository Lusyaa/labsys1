  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data="list" border stripe>
        ...
        <el-table-column label="姓名" prop="categoryId"></el-table-column>
        <el-table-column label="角色" prop="categoryName"></el-table-column>
        <el-table-column label="出生日期" prop="categoryName"></el-table-column>
