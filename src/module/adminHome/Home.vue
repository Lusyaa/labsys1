<template>
  <el-container class="home_container">
      ...
      <el-header>
        ...
        <div>
          <span>实验室综合管理信息系统</span>
        </div>
        <i @click="confirmFn" class="icon aliIcon-lab-yichu logoutstyle"></i>
      </el-header>
      <!--主体区域-->
      <el-container>
        <!--侧边栏-->
        <el-aside width="200px">
          <el-menu unique-opened :router="true"
            ...
            <el-submenu index="3">
              <template slot="title">
                <i class="el-icon-edit"></i>考勤管理
              </template>
              <el-menu-item index="/check">
                <i class="el-icon-menu"></i>考勤列表(管)
              </el-menu-item>
              <el-menu-item index="/signs">
                <i class="el-icon-menu"></i>签到列表(用)
              </el-menu-item>
            </el-submenu>
            <!--公告栏管理-->
            <el-submenu index="4">
              <template slot="title">
                <i class="el-icon-postcard"></i>公告栏管理
              </template>
              <el-menu-item index="/notices">
                <i class="el-icon-menu"></i>公告栏列表
              </el-menu-item>
            </el-submenu>
          </el-menu>
          <!--:router="true" 开启路由-->
